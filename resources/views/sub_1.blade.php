        ...
        <foreignobject x="41.04" y="195.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="함양군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    ...
                    <img src="./public/special/{{$data['함양군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="119.04" y="286.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="산청군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">산청군</h3>
                        @foreach($data['산청군']->maps as $item)
                            @if($data['산청군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['산청군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="220.04" y="195.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="합천군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">합천군</h3>
                        @foreach($data['합천군']->maps as $item)
                    ...
                    <img src="./public/special/{{$data['합천군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="373.04" y="207.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="창녕군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">창녕군</h3>

                        @foreach($data['창녕군']->maps as $item)
                            @if($data['창녕군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['창녕군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="507.04" y="221.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="밀양시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">밀양시</h3>
                        @foreach($data['밀양시']->maps as $item)
                            @if($data['밀양시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['밀양시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="621.04" y="269.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="양산시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">양산시</h3>
                        @foreach($data['양산시']->maps as $item)
                            @if($data['양산시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['양산시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="538.04" y="336.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="김해시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">김해시</h3>
                        @foreach($data['김해시']->maps as $item)
                            @if($data['김해시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['김해시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="342.04" y="336.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="함안군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">함안군</h3>
                        @foreach($data['함안군']->maps as $item)
                            @if($data['함안군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['함안군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="281.04" y="274.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="의령군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">의령군</h3>
                        @foreach($data['의령군']->maps as $item)
                            @if($data['의령군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['의령군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="220.04" y="388.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="진주시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">진주시</h3>
                        @foreach($data['진주시']->maps as $item)
                            @if($data['진주시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['진주시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="67.04" y="414.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="하동군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">하동군</h3>
                        @foreach($data['하동군']->maps as $item)
                    ...
                    <img src="./public/special/{{$data['하동군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="304.04" y="471.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="고성군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">고성군</h3>
                        @foreach($data['고성군']->maps as $item)
                            @if($data['고성군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['고성군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="185.04" y="444.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="사천시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">사천시</h3>
                        @foreach($data['사천시']->maps as $item)
                            @if($data['사천시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['사천시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="438.04" y="361.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="창원시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">창원시</h3>
                        @foreach($data['창원시']->maps as $item)
                            @if($data['창원시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['창원시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="457.04" y="546.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="거제시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">거제시</h3>
                        @foreach($data['거제시']->maps as $item)
                            @if($data['거제시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['거제시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="319.04" y="562.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="통영시">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">통영시</h3>
                        @foreach($data['통영시']->maps as $item)
                            @if($data['통영시']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['통영시']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
        <foreignobject x="142.04" y="586.07" style="width: 150px;height: 230px; background: #1b1e21; color:#fff;display: none;border-radius: 20px;" data-name="남해군">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="text-center d-flex justify-content-center align-items-center flex-column p-3">
                        <h3 class="m-0">남해군</h3>
                        @foreach($data['남해군']->maps as $item)
                            @if($data['남해군']['most'] === $item['item'])
                            <p class="m-0 main">{{$item['item']}}</p>
                            @else
                            <p class="m-0">{{$item['item']}}</p>
                            @endif
                    ...
                    <img src="./public/special/{{$data['남해군']['file']}}" alt="">
                </div>
            </div>
        </foreignobject>
